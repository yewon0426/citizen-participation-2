...
export const Part8CivicReport: React.FC<Part8Props> = ({ onResetAll }) => {
  ...
  return (
    <div className="space-y-8 pb-12">
      ...
      <div className="rounded-3xl border border-slate-800 bg-gradient-to-br from-slate-950 via-slate-900 to-indigo-950 text-white p-6 sm:p-8 shadow-xl">
        ...
        <p className="text-xs sm:text-sm text-slate-300 mt-2 leading-relaxed max-w-2xl font-medium">
        ...
        <div className="mt-8 pt-6 border-t border-white/10">
          <h3 className="text-xs font-black uppercase tracking-wider text-indigo-300 mb-4 flex items-center gap-1.5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 text-xs">
            <div className="p-4 rounded-2xl bg-white/5 border border-white/10">
              ...
              <p className="text-[11px] text-slate-400 mt-1">안전신문고 앱을 통해 보행 신호등 연장 신청 접수</p>
            </div>

            <div className="p-4 rounded-2xl bg-white/5 border border-white/10">
              <span className="font-mono text-indigo-300 font-bold">11:30 AM</span>
              <div className="font-black text-white mt-1">집단 참여의 발견</div>
              <p className="text-[11px] text-slate-400 mt-1">혼자보다 함께 목소리를 내는 정당·시민단체·이익집단 탐구</p>
            </div>
            ...
            <div className="p-4 rounded-2xl bg-white/5 border border-white/10">
              ...
              <p className="text-[11px] text-slate-400 mt-1">후보 공천, 이익 집약, 공약 제시, 정치적 책임, 감시·견제</p>
            </div>
            ...
            <div className="p-4 rounded-2xl bg-white/5 border border-white/10">
              ...
              <p className="text-[11px] text-slate-400 mt-1">같은 사회문제에 대한 정당, 시민단체, 이익집단의 목적 분석</p>
            </div>
            ...
            <div className="p-4 rounded-2xl bg-white/5 border border-white/10">
              ...
              <p className="text-[11px] text-slate-400 mt-1">공청회, 주민간담회, 자원봉사, 국회 입법예고 의견 제출</p>
            </div>
            ...
            <div className="p-4 rounded-2xl bg-white/5 border border-white/10">
              ...
              <p className="text-[11px] text-slate-400 mt-1">주민참여예산제, 조례 청구, 주민투표, 주민소환, 주민감사청구</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3.5">
          <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200">
            <span className="text-xs font-black text-blue-600">CONCEPT 01</span>
            <h4 className="text-sm font-black text-slate-900 mt-1">시민 (Citizen)</h4>
          ...
          <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200">
            <span className="text-xs font-black text-blue-600">CONCEPT 02</span>
            <h4 className="text-sm font-black text-slate-900 mt-1">개별적 참여 vs 집단적 참여</h4>
            <p className="text-xs text-slate-600 mt-1.5 leading-relaxed font-medium">
          ...
          <div className="p-4 rounded-2xl bg-blue-50/70 border border-blue-200">
            <span className="text-xs font-black text-blue-700">CONCEPT 03</span>
            <h4 className="text-sm font-black text-slate-900 mt-1">🟦 정당 (Political Party)</h4>
            <p className="text-xs text-slate-600 mt-1.5 leading-relaxed font-medium">
          ...
          <div className="p-4 rounded-2xl bg-emerald-50/70 border border-emerald-200">
            <span className="text-xs font-black text-emerald-700">CONCEPT 04</span>
            <h4 className="text-sm font-black text-slate-900 mt-1">🟩 시민단체 (Civic Group)</h4>
            <p className="text-xs text-slate-600 mt-1.5 leading-relaxed font-medium">
              시민들이 자발적으로 결성하여 비영리적으로 사회 전체의 <strong>공익 실현</strong>과 문제 해결, 권력 감시를 추구하는 단체 (정권 획득 X)
            </p>
          </div>

          <div className="p-4 rounded-2xl bg-amber-50/70 border border-amber-200">
            <span className="text-xs font-black text-amber-700">CONCEPT 05</span>
            <h4 className="text-sm font-black text-slate-900 mt-1">🟧 이익집단 (Interest Group)</h4>
            <p className="text-xs text-slate-600 mt-1.5 leading-relaxed font-medium">
          ...
          <div className="p-4 rounded-2xl bg-purple-50/70 border border-purple-200">
            <span className="text-xs font-black text-purple-700">CONCEPT 06</span>
            <h4 className="text-sm font-black text-slate-900 mt-1">주민참여제도 5총사</h4>
            <p className="text-xs text-slate-600 mt-1.5 leading-relaxed font-medium">
      ...
      {/* ============================================================ */}
      <div className="rounded-3xl border-2 border-blue-400 bg-white p-6 sm:p-8 shadow-md">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-4 pb-4 border-b border-slate-200">
          ...
          {quizSubmitted && (
            <div className="px-5 py-2.5 rounded-2xl bg-blue-600 text-white font-black text-center sm:text-right shadow-md">
              <div className="text-xs font-bold text-blue-200">나의 최종 점수</div>
          ...
          {FINAL_QUIZ_DATA.map((q, idx) => {
            ...
            return (
              ...
              >
                ...
                {quizSubmitted && (
                  <div className="mt-3.5 p-3.5 rounded-2xl bg-white border border-slate-200 text-xs text-slate-700 leading-relaxed animate-fadeIn">
        ...
        {!quizSubmitted ? (
          <div className="mt-8 pt-4 border-t border-slate-200 flex flex-col sm:flex-row items-center justify-between gap-3">
            ...
            <button
              ...
              className="w-full sm:w-auto px-8 py-3.5 rounded-full bg-blue-600 hover:bg-blue-700 text-white font-extrabold text-sm shadow-md shadow-blue-500/20 transition disabled:opacity-40"
            >
              10문항 최종 채점하기
            </button>
          </div>
        ) : (
          <div className="mt-6 p-4 rounded-2xl bg-blue-50 border border-blue-200 text-center text-xs sm:text-sm text-blue-900 font-bold">
      ...
      <div className="rounded-3xl border border-slate-200 bg-white p-6 sm:p-8 shadow-sm">
        ...
        {!isCardGenerated ? (
          <form onSubmit={handleGenerateCard} className="space-y-4 max-w-xl">
            <div>
              ...
              <input
                ...
                required
                className="w-full px-4 py-3 rounded-2xl border border-slate-200 text-xs sm:text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 font-medium"
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                rows={3}
                required
                className="w-full px-4 py-3 rounded-2xl border border-slate-200 text-xs sm:text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 font-medium leading-relaxed"
              />
            </div>

            <button
              type="submit"
              className="px-7 py-3 rounded-full bg-indigo-600 hover:bg-indigo-700 text-white font-extrabold text-xs sm:text-sm shadow-md shadow-indigo-500/20 transition flex items-center gap-2"
            >
          ...
          <div className="space-y-6 animate-fadeIn">
            ...
            <div className="max-w-md mx-auto rounded-3xl p-6 bg-gradient-to-br from-indigo-900 via-slate-900 to-blue-950 text-white border-2 border-indigo-400/40 shadow-2xl relative overflow-hidden">
              ...
              <div className="space-y-3">
                <div>
                  <div className="text-[10px] text-slate-400 font-medium">시민 성명</div>
                  <div className="text-lg font-black text-white">{studentName}</div>
                </div>

                <div>
                  <div className="text-[10px] text-slate-400 font-medium">시민 선언 (CIVIC PLEDGE)</div>
                ...
                <div className="pt-2 flex items-center justify-between text-[10px] text-slate-400 border-t border-white/10 font-mono">
            ...
            <div className="flex flex-wrap items-center justify-center gap-3 pt-2">
              <button
                onClick={handlePrint}
                className="px-5 py-2.5 rounded-full border border-slate-200 bg-white text-slate-700 hover:bg-slate-50 text-xs font-bold flex items-center gap-1.5 shadow-2xs transition"
              >
              ...
              <button
                onClick={onResetAll}
                className="px-6 py-2.5 rounded-full bg-slate-900 hover:bg-slate-800 text-white text-xs font-black flex items-center gap-1.5 shadow-md transition"
              >
                <RotateCcw className="w-4 h-4" />
